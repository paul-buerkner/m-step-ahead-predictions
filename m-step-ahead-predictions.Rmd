...
Comparing the exact block-1-SAP to the exact 1-SAP reveals substantial difference demonstrating that the assumption about distant future values containing no additional information is probably not justified in the present case.
